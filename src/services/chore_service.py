...
async def complete_task(*, task_id: str) -> dict[str, Any]:
    ...
    Raises:
        ...
        db_client.RecordNotFoundError: If task not found
    """
    return await chore_state_machine.transition_to_completed(task_id=task_id)
...
async def complete_task_no_verification(*, task_id: str) -> dict[str, Any]:
    ...
    Raises:
        ...
        db_client.RecordNotFoundError: If task not found
    """
    return await chore_state_machine.transition_to_completed_no_verification(task_id=task_id)
...
async def reset_task_to_todo(*, task_id: str) -> dict[str, Any]:
    ...
    Returns:
        Updated task record
    """
    return await chore_state_machine.transition_to_todo(task_id=task_id)
...
async def archive_task(*, task_id: str) -> dict[str, Any]:
    ...
    Returns:
        Updated task record
    """
    return await chore_state_machine.transition_to_archived(task_id=task_id)
