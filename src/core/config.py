...
class Settings(BaseSettings):
    ...
    pocketbase_admin_email: str = Field(description="PocketBase admin email for schema sync")
    pocketbase_admin_password: str = Field(description="PocketBase admin password for schema sync")
