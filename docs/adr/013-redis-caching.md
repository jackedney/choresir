# ADR 013: Redis Caching for Leaderboard Performance
...
- [ADR 011: Version Management](011-version-management.md) - Establishes version parity requirements that apply to Redis infrastructure
